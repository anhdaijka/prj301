        ...
        <div class="mt-8">
            <form action="signup" method="POST">
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="number" min="500" class="input w-full" placeholder="Enter Minimum Salary Amount" name="amount"/>
                ...
                <div class="mt-6 text-center">
                    <button type="submit" class="btn btn-secondary w-full" name="nextStep" value="4">Continue</button>
                </div>
                <div class="mt-2 text-center">
                    <button type="submit" name="nextStep" value="4" class="btn btn-ghost w-full">Skip</button>
                </div>
